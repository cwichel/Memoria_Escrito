		...
		\label{sub:02_metodos_de_captura}
			...
			\label{ssub:02_tecnologias_actuales}
				...
				\begin{enumerate}
					...
					\begin{figure}[H]
						...
						\label{fig:02_et_ssc}
					\end{figure}
					\footnotetext{Imagen obtenida desde \url{http://www.dizziness-and-balance.com/practice/default.htm}}
					...
					\begin{figure}[H]
						...
						\label{fig:02_et_eog}
					\end{figure}
					\footnotetext{Imagen obtenida desde \url{http://sbiwiki.cns.ki.se/mediawiki/index.php/Natmeg/checklist_MEG_preparation}}
					...
					\end{figure}
					\footnotetext{Imágenes obtenidas desde \url{https://www.tobii.com/} y \url{https://www.microway.com.au/} respectivamente.}
			...
			\label{ssub:02_comparativa_eyetracker}
				...
				\begin{table}[H]\begin{center}\footnotesize{
					...
					\end{tabular}}
					\caption[Comparativa de los sistemas de adquisición encontrados]{Comparativa de los sistemas de adquisición encontrados en \cite{article:eyetracker_eggert, article:eyetracker_richardson, dissertation:eyetrackers}}
