			...
			\label{ssub:02_tecnologias_actuales}
				...
				\begin{enumerate}
					...
					\begin{figure}[H]
						...
						\subfloat[Posición de las reflexiones de la córnea (P1) relativas al centro de la pupila.]{\includegraphics[width=0.55\textwidth]{cap_02_et_vog2}}
					...
					\begin{figure}[H]
						\centering
						\subfloat[Tobii Pro Glasses 2 \cite{website:tobii}]{\includegraphics[width=0.4\textwidth]{cap_02_et_vog_1}}\hspace{5mm}
						\subfloat[MiraMetrix S2 \cite{website:microway}]{\includegraphics[width=0.4\textwidth]{cap_02_et_vog_2}}
