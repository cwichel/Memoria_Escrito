...
\label{cha:02_estado_del_arte}
	...
	\label{sub:02_metodos_de_captura}
		...
		\label{sub:02_tecnologias_actuales}
			...
			\begin{enumerate}\setlength\itemsep{-0.5em}
				...
				\begin{figure}[H]
					\centering
					\subfloat[Reflexiones de Purkinje-Sanson]{\includegraphics[width=0.33\textwidth]{cap_02_et_vog1}}\hfill
	...
	\label{sec:02_sistemas_de_estimulacion_visual}
		...
		\label{sub:02_software_de_estimulacion}
			...
			\vspace{-5mm}
			\begin{table}[H]\begin{center}\footnotesize{
					\singlespacing{\begin{tabular}{| C{0.2\textwidth} | C{0.15\textwidth} | C{0.15\textwidth} | C{0.15\textwidth} | C{0.16\textwidth} |}
					\hline
					...
					Imágenes y Vídeo 				& \multicolumn{4}{c|}{Si}\\\hline
