...
\label{sec:03_setup}
	...
	\begin{table}[H]\begin{center}\fontsize{10pt}{1em}{
		...
		\begin{tabular}{| C{0.11\textwidth} | C{0.14\textwidth} | R{0.18\textwidth} L{0.5\textwidth} |} \hline
			\multirow{7}{*}{Hardware} 	& \multirow{4}{*}{PC} 			& Procesador: 		& Intel Core i7-3770 \\
									& 							& Memoria RAM:		& 16.0GB, DDR3, 650MHz \\
									& 							& Disco duro: 		& Samsung SSD, 840 Series, 120GB \\
									& 							& Tarjeta gráfica: 	& NVIDIA GeForce GTX 660 Ti, 2GB \\ \cline{2-4}
									& \multirow{2}{*}{Monitores} 	& Principal:			& Samsung SyncMaster, 1680x1050px, 60Hz \\ 
									& 							& Secundario: 		& Samsung SyncMaster, 1680x1050px, 60Hz \\ \cline{2-4}
									& Adquisición 				& Eyetracker: 		& EyeTribe \\ \hline
			\multirow{4}{*}{Software} 	& \multirow{2}{*}{Entorno} 		& SO:				& Windows 10 Pro x64 \\ 
									& 							& Base:				& Python 2.7 x86, Anaconda \\ \cline{2-4}
									& \multirow{2}{*}{Módulos}		& Principal: 			& PsychoPy 1.84.2 \\
									& 							& Requeridos:			& Ver anexo \ref{appendix_python_install} \\ \hline
		\end{tabular}}
	...
	\begin{enumerate}
		\item El eyetracker a utilizar solo tiene disponible sus drivers para Mac y Windows. Debido a la facilidad de encontrar computadoras con %\acrshort{SO} Windows se decanta por este.
...
\label{sec:03_diseño_sistema}
	...
	\label{sub:03_implementacion_backtend}
		...
		\begin{enumerate}
			...
			\vspace{-8mm}			
			\begin{center}\fontsize{10pt}{1em}{\singlespacing{
				\begin{longtable}[H]{| C{0.15\textwidth} | R{0.13\textwidth} L{0.67\textwidth} |} \hline
					% ===============================================
			...
			\begin{center}\fontsize{10pt}{1em}{\singlespacing{
				\begin{longtable}[H]{| C{0.15\textwidth} | R{0.13\textwidth} L{0.67\textwidth} |} \hline
					...
					Descripción & \multicolumn{2}{L{0.75\textwidth}|}{
					Método que inicia una conexión con el archivo de base de datos. Si el archivo de base de datos epecificado en el constructor no existe, crea uno nuevo utilizando las configuraciones especificadas en \ref{appendix_sql_script}.
					}\\\hline
					Inputs 					& void. 	&  
					\\\hline
					Return 					& void. 	& 
			...
			\begin{center}\fontsize{10pt}{1em}{\singlespacing{
				\begin{longtable}[H]{| C{0.15\textwidth} | R{0.13\textwidth} L{0.67\textwidth} |} \hline
					...
					Descripción & \multicolumn{2}{L{0.75\textwidth}|}{
					Método estático. Entrega una lista de las configuraciones disponibles para los eyetrackers. Dichas configuraciones pueden ser encontradas en la carpeta 'saccadeApp/resources/eyetrackers' del proyecto. 
					}\\\hline
					Inputs 					& void. 	& 
					\\\hline
					Return 					& list.		& 
