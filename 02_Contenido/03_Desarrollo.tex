	...
	\label{sec:03_diseño_sistema}
		...
		\label{sub:03_gui}
			...
			\begin{enumerate}\setlength\itemsep{-0.5em}
				...
				\begin{figure}[H]
					\centering
					\subfloat[Pestaña de experimentos.]{\includegraphics[width=0.51\textwidth]{cap_03_gui_01}}
					\subfloat[Pestaña de configuración.]{\includegraphics[width=0.51\textwidth]{cap_03_gui_02}}\\
					\subfloat[Pestaña de ejecución.]{\includegraphics[width=0.51\textwidth]{cap_03_gui_03}}
				...
				\item \textbf{\textref{ExperimentApp}:} Permite revisar y/o configurar un experimento, las tareas que lo componen y la secuencia de ejecución de las mismas. Se puede acceder a ella desde \textref{SaccadeApp} mediante los botones \textref{New} y \textref{Edit} ubicados en la pestaña \textref{Experiments}.
				\begin{figure}[H]
					\centering
				...
				\item \textbf{\textref{CopyExperimentApp}:} Permite realizar una copia de un experimento existente, para lo cual se requiere obtener un nuevo código y versión. Se puede acceder a ella desde \textref{SaccadeApp} mediante el botón \textref{copy} ubicado en la pestaña \textref{Experiments}.
				\begin{figure}[H]
					\centering
				...
				\item \textbf{\textref{ConfigurationApp}:} Permite revisar/configurar las características de un perfil de configuración. Se puede acceder a esta ventana desde \textref{SaccadeApp} mediante los botones \textref{New} y \textref{Edit} ubicados en la pestaña \textref{Configuration}.
				\begin{figure}[H]
					\centering
